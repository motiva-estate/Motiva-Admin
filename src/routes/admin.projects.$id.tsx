    ...
    <div className="max-w-4xl space-y-6">
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => navigate({ to: "/admin/projects" })}>Back</Button>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label>Coords</Label>
              <Input placeholder="N 6°26′ · E 3°26′" value={form.coords ?? ""} onChange={(e) => setForm((f) => ({ ...f, coords: e.target.value }))} />
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="space-y-2">
              ...
              <Select value={form.propertyType ?? "Villa"} onValueChange={(v) => setForm((f) => ({ ...f, propertyType: v as SanityPropertyType }))}>
            ...
            <div className="space-y-2">
              ...
              <Input placeholder="Phase 1" value={form.phaseLabel ?? ""} onChange={(e) => setForm((f) => ({ ...f, phaseLabel: e.target.value }))} />
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <Textarea rows={6} value={amenitiesText} onChange={(e) => setAmenitiesText(e.target.value)} placeholder="Private lap pool&#10;Home cinema" />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <Textarea rows={5} value={nearbyText} onChange={(e) => setNearbyText(e.target.value)} placeholder="Ikoyi Golf Club&#10;Landmark Beach" />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <Button size="sm" variant="outline" onClick={addFaq}>Add</Button>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          {faq.map((item, i) => (
            <div key={i} className="space-y-2 rounded border border-border p-3">
              ...
              <Button size="sm" variant="ghost" className="text-destructive" onClick={() => removeFaq(i)}>Remove</Button>
            </div>
          ))}
        </CardContent>
      </Card>
